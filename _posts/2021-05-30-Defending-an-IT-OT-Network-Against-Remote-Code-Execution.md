...
Once I had obtained the IP address, I ran a port scan using Nmap in the Metasploit Framework database to scan the AcmeCo router. The command for the port scan and the results are shown in Figure 3.
...
_Sending the File with Secure Copy_

![Sending the File with Secure Copy](/assets/images/defending-it-ot-network/Fig10-scp.png)
